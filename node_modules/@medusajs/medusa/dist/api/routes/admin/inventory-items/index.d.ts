 ...
 */
export declare type DecoratedInventoryItemDTO = InventoryItemDTO & {
 ...
 *     description: The number of items per page
 */
export declare type AdminInventoryItemsListWithVariantsAndLocationLevelsRes = PaginatedResponse & {
