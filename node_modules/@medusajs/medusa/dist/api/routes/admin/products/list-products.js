...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productService, inventoryService, productVariantInventoryService, salesChannelService, pricingService, _a, skip, take, relations, manager, _b, rawProducts, count, products, shouldSetPricing, shouldSetAvailability, _c, salesChannelsIds;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                _b = __read.apply(void 0, [_d.sent(), 2]), rawProducts = _b[0], count = _b[1];
                ...
                if (!shouldSetPricing) return [3 /*break*/, 3];
            ...
            case 3:
                ...
                if (!(inventoryService && shouldSetAvailability)) return [3 /*break*/, 6];
                return [4 /*yield*/, salesChannelService.listAndCount({}, { select: ["id"] })];
            case 4:
                _c = __read.apply(void 0, [_d.sent(), 1]), salesChannelsIds = _c[0];
