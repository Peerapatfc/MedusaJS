...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, validated, customer_id, productVariantInventoryService, productService, pricingService, cartService, regionService, rawProduct, sales_channel_id, regionId, currencyCode, cart, region, decoratedProduct, shouldSetPricing, shouldSetAvailability, decoratePromises;
    var _a, _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 5:
                ...
                _d.sent();
                res.json({
                    product: (0, clean_response_data_1.cleanResponseData)(decoratedProduct, req.allowedProperties || []),
                });
                return [2 /*return*/];
        }
    });
