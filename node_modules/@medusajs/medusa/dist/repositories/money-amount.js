...
exports.MoneyAmountRepository = database_1.dataSource
    ...
    insertBulk: function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var queryBuilder, rawMoneyAmounts_1, rawMoneyAmounts;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        rawMoneyAmounts_1 = _a.sent();
                        return [2 /*return*/, rawMoneyAmounts_1.generatedMaps.map(function (d) {
                                return _this.create(d);
                            })];
                    case 2: return [4 /*yield*/, queryBuilder.returning("*").execute()];
                    case 3:
                        rawMoneyAmounts = _a.sent();
                        return [2 /*return*/, rawMoneyAmounts.generatedMaps.map(function (d) { return _this.create(d); })];
                }
            });
        });
    },
    ...
    deleteVariantPricesNotIn: function (variantIdOrData, prices) {
        return __awaiter(this, void 0, void 0, function () {
            var data, queryBuilder, _loop_1, data_1, data_1_1, data_;
            var e_1, _a;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        _loop_1 = function (data_) {
                            ...
                            var orWhere = [];
                            try {
                                for (var _d = (e_2 = void 0, __values(data_.prices)), _e = _d.next(); !_e.done; _e = _d.next()) {
                                    var price = _e.value;
                            ...
                            queryBuilder.orWhere(new typeorm_1.Brackets(function (localQueryBuild) {
    ...
    findManyForVariantsInRegion: function (variant_ids, region_id, currency_code, customer_id, include_discount_prices, include_tax_inclusive_pricing) {
        if (include_tax_inclusive_pricing === void 0) { include_tax_inclusive_pricing = false; }
        return __awaiter(this, void 0, void 0, function () {
            var date, qb, _a, prices, count, groupedPrices;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        qb = this.createQueryBuilder("ma")
                            .leftJoinAndSelect("ma.price_list", "price_list")
                            .where({ variant_id: (0, typeorm_1.In)(variant_ids) })
                        ...
                        return [4 /*yield*/, qb.getManyAndCount()];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 2]), prices = _a[0], count = _a[1];
