...
exports.ProductRepository = database_1.dataSource.getRepository(models_1.Product).extend({
    queryProducts: function (optionsWithoutRelations, shouldCount) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var tags, price_lists, sales_channels, categoryId, categoriesQuery, include_category_children, discount_condition_id;
            var _this = this;
            return __generator(this, function (_p) {
                ...
                include_category_children = (_k = optionsWithoutRelations === null || optionsWithoutRelations === void 0 ? void 0 : optionsWithoutRelations.where) === null || _k === void 0 ? void 0 : _k.include_category_children;
                ...
                return [2 /*return*/, (0, repository_1.queryEntityWithoutRelations)({
                        repository: this,
                        ...
                        customJoinBuilders: [
                            ...
                            function (qb, alias) { return __awaiter(_this, void 0, void 0, function () {
                                var categoryIds, categoryRepository, categories, _loop_1, categories_1, categories_1_1, category, e_1_1, joinScope;
                                var e_1, _a;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            categoryIds = [];
                                            if (!categoryId) return [3 /*break*/, 9];
                            ...
                            customJoinBuilders: [
                                function (queryBuilder, alias, topLevel) {
                                    if (topLevel === "variants") {
                                        queryBuilder.leftJoinAndSelect("".concat(alias, ".").concat(topLevel), topLevel, "".concat(topLevel, ".deleted_at IS NULL"));
    ...
    getFreeTextSearchResultsAndCount: function (q, options, relations) {
        ...
        if (relations === void 0) { relations = []; }
        return __awaiter(this, void 0, void 0, function () {
            var option_, productAlias, pricesAlias, variantsAlias, collectionAlias, tagsAlias, tags, price_lists, sales_channels, discount_condition_id, categoriesQuery, qb, variantPricesAlias, joinedWithTags, joinedWithPriceLists, _b, results, count, orderedResultsSet, products, productsMap, orderedProducts;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
