                                    ...
                                    case 2:
                                        if (loaded.prototype instanceof medusa_interfaces_1.FulfillmentService) {
                                            ...
                                            container.register((_b = {},
                                                ...
                                                _b["fp_".concat(loaded.identifier)] = (0, awilix_1.aliasTo)(name),
                                                _b));
                                        }
                                            ...
                                            container.register((_c = {},
                                                ...
                                                _c["noti_".concat(loaded.identifier)] = (0, awilix_1.aliasTo)(name),
                                                _c));
                                        }
                                            ...
                                            container.register((_d = {},
                                                ...
                                                _d["fileService"] = (0, awilix_1.aliasTo)(name),
                                                _d));
                                        }
                                            ...
                                            container.register((_e = {},
                                                ...
                                                _e["searchService"] = (0, awilix_1.aliasTo)(name),
                                                _e));
                                            ...
                                            container.register((_f = {},
                                                ...
                                                _f["tp_".concat(loaded.identifier)] = (0, awilix_1.aliasTo)(name),
                                                _f));
                                        }
                                        else {
                    ...
                    return [4 /*yield*/, Promise.all(files.map(function (fn) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 3:
                                        err_2 = _a.sent();
                                        throw new Error("A setup function from ".concat(pluginDetails.name, " failed. ").concat(err_2));
                                    case 4: return [2 /*return*/];
                                }
                            });
                        }); }))];
