...
var ProductService = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, productRepo.findOneWithRelations((0, utils_2.objectToStringPath)(relations), query)];
                    case 1:
                        product = _b.sent();
                        if (!product) {
    ...
    ProductService.prototype.prepareListQuery_ = function (selector, config) {
        ...
        if (config.relations && config.relations.length > 0) {
            query.relations = (0, utils_2.buildRelations)(config.relations);
        }
        if (config.select && config.select.length > 0) {
            query.select = (0, utils_2.buildSelects)(config.select);
        }
        var rels = (0, utils_2.objectToStringPath)(query.relations);
