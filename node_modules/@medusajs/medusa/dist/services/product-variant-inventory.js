...
var ProductVariantInventoryService = /** @class */ (function (_super) {
    ...
    ProductVariantInventoryService.prototype.attachInventoryItem = function (variantId, inventoryItemId, requiredQuantity) {
        return __awaiter(this, void 0, void 0, function () {
            var variantInventoryRepo, existing, quantityToStore, variantInventory;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    ...
                    case 1:
                        ...
                        _a.sent();
                        // Verify that item exists
                        return [4 /*yield*/, this.inventoryService_.retrieveInventoryItem(inventoryItemId, {
                                select: ["id"],
                    ...
                    case 3:
                        ...
                        if (typeof requiredQuantity !== "undefined") {
                            if (requiredQuantity < 1) {
                                throw new utils_1.MedusaError(utils_1.MedusaError.Types.INVALID_DATA, "Quantity must be greater than 0");
                            }
                            else {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        _b.label = 4;
                    case 4: return [4 /*yield*/, Promise.all(variantInventory.map(function (inventoryPart) { return __awaiter(_this, void 0, void 0, function () {
                            var itemQuantity;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        itemQuantity = inventoryPart.required_quantity * quantity;
                                        return [4 /*yield*/, this.inventoryService_.createReservationItem(__assign(__assign({}, toReserve), { location_id: locationId, inventory_item_id: inventoryPart.inventory_item_id, quantity: itemQuantity }), moduleContext)];
                                    case 1: return [2 /*return*/, _a.sent()];
                                }
                            });
                        }); }))];
                    case 5:
                        ...
                        return [2 /*return*/, reservationItems];
                }
            });
        });
    };
